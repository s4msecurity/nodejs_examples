...
*/
router.post("/", function (req, res, next) { //gelen stoğu yazdıracağımız ekran. Bu kısımda gelen verinin post metoduyla gelmesini filtreleyerek "use" kullanmadan sadece post gelmesi durumunda çalışması sağlndı.
    //database kayıt işlemleri için yapılabilir.
    console.log(req.body) //body içinde formadan gelen bilgileri alınmayı sağlayabiliriz. Express ile body bilgisi eklendi.
    res.redirect("/")
    next()
