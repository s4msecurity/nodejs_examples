...
indexPage.get("/",function(req,res, next){
    res.render("index", {dinamikIcreik: admin.dinamik, title : "Ana Sayfa"}) //render ile index pug dosyasına dinmaikicerik isimli admin yani addstock js dosyasındaki gelen veri alındı.
})
